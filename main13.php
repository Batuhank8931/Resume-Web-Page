...
<body>
    ...
    <div class="h-25 back">
        <div class="navbar-container col-12 col-sm-5">
            <ul class="d-flex justify-content-between m-4 m-sm-5 mt-0 mt-sm-0 mb-0 mb-sm-0 mr-4 mr-sm-5 ">
              <li class="nav-link pr-0 submit1 ">
                <a href="#">Experience
                </a>
              ...
              <li class="nav-link p-0 submit3 active-link" type="button">
                <a href="#">Projects</a>
                <div class="underline mt-3"></div>
              </li>
            </ul>
    ...
    <div class="d-flex">
        ...
        <div class=" back col-sm-2 d-sm-flex flex-column d-none">
            ...
            <div>
                ...
                <div class="row p-0 m-0" id="Projects" style="display: none;">
                    <div class="searchform " style="height: 200px;" >
        ...
        <div class="col-12 col-sm-10">                    
            ...
            <div class="m-4 m-sm-5 border border-grey ">
                <div class="row m-0">
                    <p class="h2" style="padding:10px; ">Projects</p>
                </div>  
                    <?php
                        $projectnumbers=$data['projects']["title"];
                        $projectcount=count($projectnumbers);

                        $x=0;

                        while ($x < $projectcount){
                            $projecttitle=$data['projects']["title"][$x];
                            $projectlink=$data['projects']["link"][$x];
                            $projectlinknames=$data['projects']["link_name"][$x];
                            $projectdescription=$data['projects']["description"][$x];
                            $projectimages=$data['projects']["project_images"][$x];

                            echo('
                            <div class="project-area col-12 mt-2">
                                <div class="d-flex flex-column-reverse flex-lg-row ">
                                    <div id="imageCarouselA');echo($x);echo('" class="carousel d-none d-lg-flex slide col-12 col-lg-8 p-4" data-ride="carousel">');

                            if (gettype($projectimages) == "array") {
                                $xi=0;
                                $imagecount=count($projectimages);
                                while ($xi < $imagecount){
                                    $decodedImage = base64_decode($projectimages[$xi]);
                                    if ($xi ==0){
                                        echo('
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                            <img class="img-thumbnail" src="data:image/png;base64,' . base64_encode($decodedImage) . '" style="border-radius: 7%; " alt="PNG Image">
                                            </div>                                        
                                        ');
                                    } else {
                                        echo('
                                ...
                                echo ('
                                    ...
                                    <a class="carousel-control-prev" href="#imageCarouselA');echo($x);echo('" role="button" data-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" href="#imageCarouselA');echo($x);echo('" role="button" data-slide="next">
                                ...
                                $decodedImage = base64_decode($projectimages);
                                echo ('
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                        <img class="img-thumbnail" src="data:image/png;base64,' . base64_encode($decodedImage) . '" style="border-radius: 7%;" alt="PNG Image">
                            ...
                            echo('
                                    <div class="col-12 col-lg-4 p-4 pt-lg-3">
                                        <h3 class="title"> #');echo($x+1);echo('</h3>
                                        <h3 class="title">');echo($projecttitle);echo('</h3>

                                        <div id="imageCarouselB');echo($x);echo('" class="carousel d-lg-none slide col-12 col-lg-8 p-4" data-ride="carousel">');
                                        ...
                                        if (gettype($projectimages) == "array") {
                                            ...
                                            echo ('
                                                ...
                                                <a class="carousel-control-prev" href="#imageCarouselB');echo($x);echo('" role="button" data-slide="prev">
                                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                                <a class="carousel-control-next" href="#imageCarouselB');echo($x);echo('" role="button" data-slide="next">
                                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                    <span class="sr-only">Next</span>
                                                </a>                                   
                                                ');
                            ...
                            echo('
                                        <h6>');echo($projectdescription);echo('</h6><br>');
                            if (gettype($projectlink) == "array") {
                                $xp=0;
                                $linkcount=count($projectlink);
                                while ($xp < $linkcount){
                                    echo('<h6><a href="');echo($projectlink[$xp]);echo('">');echo($projectlinknames[$xp]);echo('</a></h6>');
                                    $xp++;    
                                };

                            } else {
                                echo('<h6><a href="');echo($projectlink);echo('">');echo($projectlinknames);echo('</a></h6>');
                            };
                            echo('
                                    </div>
                                </div>
