    ...
    <div class="h-25 back">
        <div class="navbar-container col-12 col-sm-5">
            <ul class="d-flex justify-content-between m-4 m-sm-5 mt-0 mt-sm-0 mb-0 mb-sm-0 mr-4 mr-sm-5 ">
              ...
              <li class="nav-link p-0 submit2 active-link" type="button">
                <a href="#">Skills</a>
                <div class="underline mt-3" ></div>
              </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="apland-timeline-area">
                                <?php
                                    $skillheaders = $data['skills']["subjetcs"];

                                    $headernumber= count($skillheaders);
                                    $x = 0;
                                    while ($x < $headernumber){
                                        $skilltitle= $data['skills']["subjetcs"][$x];

                                        echo('  
                                        <!-- Single Timeline Content-->
                                        <div class="single-timeline-area">
                                            <div class="row m-0">
                                                <p class="h2" style="padding:10px; text-align: left; margin-top:10px;">#');echo(($x+1)." ".$skilltitle." skills:");echo('</p>
                                            </div> 
                                            <div class=" col-12 row" style="margin:0px">');


                                        $skillnumber=$data['skills'][$x];
                                        $skillcount =count($skillnumber);
                                        $xi=0;
                                        while($xi <  $skillcount){
                                            $skillname=$data['skills'][$x][$xi];
                                            $skillrateheader=" rate";
                                            $skilllogoheader=" logo";
                                            
                                            $skilllogonumber=$x.$skilllogoheader;         
                                            $skillratenumber=$x.$skillrateheader;                         

                                            $decodedImage = base64_decode($data['skills'][$skilllogonumber][$xi]);
                                            echo('
                                            <div class="singleline col-12 col-md-6 col-xl-4">
                                                <div class="single-timeline-content d-flex">
                                                    <div calss="col-3 col-md-6 col-lg-6">
                                                        <img class="img-thumbnail" src="data:image/png;base64,' . base64_encode($decodedImage) . '" style="border-radius: 50%; margin: 20px;" alt="PNG Image">
                                                    </div>
                                                    <div class="timeline-text col-9 col-md-6 col-lg-6">
                                                    <h5>');echo($skillname);echo('</h5>');
                                                    
                                                    for ($i = 1; $i <= 5; $i++) {
                                                        if ($i <= ($data['skills'][$skillratenumber][$xi])) {
